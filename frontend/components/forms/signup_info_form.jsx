const React = require('react'),
      ...
      SignUpFormData = require('./signup_form_data'),
      Form = require('./form'),
      startPage = 0,
      Pages = SignUpFormData.pages;
...
// HANDLE RETURNED ERRORS
  ...
  _onChange() {
    let type = SignUpFormData.form.type,
...
// HANDLE FORM INPUT AND SUBMISSION
  ...
  _backCallback(e) {
    e.preventDefault();
    SignUpFormData.pages[this.state.page].about.backCallback.call(this, this.state, true);
  },
