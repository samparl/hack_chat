...
# ADMIN
@admin = User.new({team: nil, first_name: 'admin', last_name: ' user', username: 'admin', email: 'admin@admin.com', password: 'password' })
...
# USERS
user1 = User.create({team: @team1, first_name: 'user', last_name: ' 1', username: 'user1', email: 'user1@user.com', password: 'password' })
user2 = User.create({team: @team1, first_name: 'user', last_name: ' 2', username: 'user2', email: 'user2@user.com', password: 'password' })
user3 = User.create({team: @team1, first_name: 'user', last_name: ' 3', username: 'user3', email: 'user3@user.com', password: 'password' })
user4 = User.create({team: @team1, first_name: 'user', last_name: ' 4', username: 'user4', email: 'user4@user.com', password: 'password' })
user5 = User.create({team: @team1, first_name: 'user', last_name: ' 5', username: 'user5', email: 'user5@user.com', password: 'password' })
